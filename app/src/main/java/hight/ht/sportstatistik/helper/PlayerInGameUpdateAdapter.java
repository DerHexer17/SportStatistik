...
public class PlayerInGameUpdateAdapter extends ArrayAdapter<Player> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(hight.ht.sportstatistik.R.layout.list_item_update_player_in_game, null);
        }

        final TextView txtName = (TextView) convertView.findViewById(hight.ht.sportstatistik.R.id.name);
        final TextView txtNumber = (TextView) convertView.findViewById(hight.ht.sportstatistik.R.id.number);
        final Button minus = (Button) convertView.findViewById(hight.ht.sportstatistik.R.id.minus);
        final Button plus = (Button) convertView.findViewById(hight.ht.sportstatistik.R.id.plus);
        ...
        final Switch actionSwitch = (Switch) convertView.findViewById(hight.ht.sportstatistik.R.id.switchUpdatePlayer);
