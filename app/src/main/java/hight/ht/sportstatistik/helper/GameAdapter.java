...
import hight.ht.sportstatistik.activities.GameActivity;
...
public class GameAdapter extends ArrayAdapter<Game> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(hight.ht.sportstatistik.R.layout.list_item_games, null);
        }

        TextView txtTitle = (TextView) convertView.findViewById(hight.ht.sportstatistik.R.id.label);
