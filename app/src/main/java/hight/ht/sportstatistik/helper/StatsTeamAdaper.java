...
public class StatsTeamAdaper extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(hight.ht.sportstatistik.R.layout.ex_list_group_stats_team, null);
        }

        TextView statTitle = (TextView) convertView.findViewById(hight.ht.sportstatistik.R.id.labelGroup);
        TextView sum = (TextView) convertView.findViewById(hight.ht.sportstatistik.R.id.sumGroup);
        TextView avg = (TextView) convertView.findViewById(hight.ht.sportstatistik.R.id.averageGroup);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) this.context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = infalInflater.inflate(hight.ht.sportstatistik.R.layout.ex_list_item_stats_team, null);
        }

        TextView statTitleItem = (TextView) convertView.findViewById(hight.ht.sportstatistik.R.id.labelItem);
        TextView sumItem = (TextView) convertView.findViewById(hight.ht.sportstatistik.R.id.sumItem);
        TextView avgItem = (TextView) convertView.findViewById(hight.ht.sportstatistik.R.id.averageItem);
        TextView number = (TextView) convertView.findViewById(hight.ht.sportstatistik.R.id.numberKit);
        DecimalFormat f = new DecimalFormat("#0.00");
        //lblListHeader.setTypeface(null, Typeface.BOLD);
        Stats stat = getChild(groupPosition, childPosition);
        //number.setText(String.valueOf(stat.getPlayer().getNummmer()));
