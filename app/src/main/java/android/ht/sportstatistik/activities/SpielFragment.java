...
public class SpielFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ListView lv = (ListView) getActivity().findViewById(R.id.listSpieler);
        lv.setAdapter(new SpieleAdapter(getActivity().getApplicationContext(), (List<Spieler>) dbh.getAllPlayers()));
    }
    ...
    private class SpieleAdapter extends BaseAdapter {
        ...
        Context context;
        List<Spieler> spiele;
        public SpieleAdapter(Context context, List<Spieler> spiele){
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                ...
                convertView = mInflater.inflate(R.layout.fragment_spiel, null);
            }


            TextView txtTitle = (TextView) convertView.findViewById(R.id.textSpiele);
